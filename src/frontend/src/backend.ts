...
export class Backend implements backendInterface {
    ...
    async addPortfolioItem(arg0: string, arg1: string, arg2: Category, arg3: string): Promise<void> {
    ...
    async getPortfolioByCategory(arg0: Category): Promise<Array<PortfolioItem>> {
        if (this.processError) {
            try {
